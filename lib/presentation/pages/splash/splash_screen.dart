    ...
    return BlocListener<AuthenticatorWatcherBloc, AuthenticatorWatcherState>(
      listener: (context, state) {
        state.maybeMap(
          orElse: () {},
          authenticating: (_) {},
          authenticated: (_) => context.replaceNamed(AppRoutes.booksRouteName),
          isFirstTime: (_) => context.replaceNamed(AppRoutes.booksRouteName),
          unauthenticated: (_) =>
              context.replaceNamed(AppRoutes.booksRouteName),
        );
      },
      child: Scaffold(
        body: Container(
